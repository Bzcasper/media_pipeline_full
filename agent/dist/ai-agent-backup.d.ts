...
export declare const transcriptionTool: import("ai").Tool<unknown, unknown>;
export declare const metadataExtractionTool: import("ai").Tool<unknown, unknown>;
export declare const albumCoverTool: import("ai").Tool<unknown, unknown>;
export declare const videoGenerationTool: import("ai").Tool<unknown, unknown>;
export declare const gcsUploadTool: import("ai").Tool<unknown, unknown>;
export declare const weaviateIndexTool: import("ai").Tool<unknown, unknown>;
export declare class MediaPipelineAgent {
     ...
     */
    streamProcessing(input: any): AsyncGenerator<{
        type: string;
        jobId: string;
        message: string;
        step?: undefined;
...
//# sourceMappingURL=ai-agent-backup.d.ts.map
...
export declare class MediaServerClient {
    ...
    transcribeAudio(audioFile: File | string, language?: string): Promise<any>;
    imageToVideo(imageFile: File | string, options?: any): Promise<any>;
    runGpuChain(chainName: string, inputs: any): Promise<any>;
    uploadFile(file: File, mediaType: string): Promise<any>;
}

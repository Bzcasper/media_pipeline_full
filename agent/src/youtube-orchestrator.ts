...
export class YouTubeVideoOrchestrator {
   ...
   */
  async run(input: YouTubeVideoInput): Promise<YouTubeVideoOutput> {
    ...
    try {
      ...
      const scriptGenerator = new ScriptGeneratorSkill(this.logger);
      ...
      const scriptChunker = new ScriptChunkerSkill(this.logger);
      ...
      const imagePromptGenerator = new ImagePromptGeneratorSkill(this.logger);
      ...
      const imageGenerator = new ImageGeneratorSkill(this.logger);
      ...
      const imageValidator = new ImageValidatorSkill(this.logger);
      ...
      const imageToVideo = new ImageToVideoSkill(this.logger);
      ...
      const videoAssembler = new VideoAssemblerSkill(this.logger);
   ...
   */
  private async generateMetadata(script: string, query: string) {
